    ...
    keyboardDown(event) {
        ...
        if (!event.repeat) {
            ...
            if (global.canUpgrade) {
                ...
                case global.KEY_CHOOSE_9:  this.parent.socket.talk('U', 8); break;
                case global.KEY_CHOOSE_10:  this.parent.socket.talk('U', 9); break;
                case global.KEY_CHOOSE_11:  this.parent.socket.talk('U', 10); break;
                case global.KEY_CHOOSE_12:  this.parent.socket.talk('U', 11); break;
                case global.KEY_CHOOSE_13:  this.parent.socket.talk('U', 12); break;
                case global.KEY_CHOOSE_14:  this.parent.socket.talk('U', 13); break;
                }
            }
        }
    }    
